...
class UI:
    ...
    def GetMessage(self):
        while self.run:
            ...
            # Các group chứa người dùng
            if msg.startswith("!GROUP"):
                group_name = msg[len("!GROUP"):] 

            # Tên tài khoản ngắt kết nối
            elif msg.startswith("!DISCONNECT"):
                username = msg[len("!DISCONNECT"):]

            # Tên tài khoản đang kết nối
            elif msg.startswith("!CONNECT"):
                username = msg[len("!CONNECT"):]

            # Thêm tên tài khoản có sẵn
            elif msg.startswith("!ADD"):
                username = msg[len("!ADD"):]
