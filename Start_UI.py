...
class Start_UI:
    ...
    def __init__(self, client):
        ...
        self.avatar_ui.btnContinue.config(command=self.AvaToLogin)
    ...
    def AvaToLogin(self):
        self.client.send_messages(self.avatar_ui.changed_ava)
        if self.avatar_ui.changed_ava == "Yes":
            self.client.Avatar_Selection(self.avatar_ui.out_img_path)
